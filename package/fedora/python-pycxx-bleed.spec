...
Source0:        {{{ git_pack path=$GIT_ROOT dir_name=pycxx source_name=pycxx.tgz }}}
# Patch0:  remove unnecessary 'Src/' directory from include path in sources
Patch0:         $GIT_ROOT/fedora/package/%{name}-7-change-include-paths.patch
...
%prep
{{{ git_setup_macro dir_name=pycxx }}}
...
%doc README.md COPYRIGHT Doc/Python2/
%dir %{_includedir}/CXX
%{_includedir}/CXX/*.hxx
%{_includedir}/CXX/*.h
...
%doc README.md COPYRIGHT Doc/Python3/ 
%dir %{_includedir}/CXX
%{_includedir}/CXX/*.hxx
%{_includedir}/CXX/*.h
...
%changelog
* Sat Nov 20 2021 Monty <xiphmont@gmail.com> - 7.1.5-0_bleed
- Update to 7.1.5 to remove deprecated and soon-to-be-removed Unicode API methods
- Add rpkg configuration
